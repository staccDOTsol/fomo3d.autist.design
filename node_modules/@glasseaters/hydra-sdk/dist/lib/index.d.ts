...
import { Connection, PublicKey, RpcResponseAndContext, SignatureResult, Signer, Transaction, TransactionInstruction, TransactionSignature } from "@solana/web3.js";
...
export declare class FanoutClient {
    ...
    static mintMembershipVoucher(fanoutForMintConfig: PublicKey, membershipMint: PublicKey, fanoutMint: PublicKey, programId?: PublicKey): Promise<[PublicKey, number]>;
